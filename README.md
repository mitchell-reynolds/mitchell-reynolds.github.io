...
On MacOS, I followed the steps by installing [Homebrew per Jekyll](https://jekyllrb.com/docs/installation/macos/)

1. [`gem install jekyll`]
2. `gem install jekyll-seo-tag && gem install jekyll-paginate && gem install jekyll-sitemap`
